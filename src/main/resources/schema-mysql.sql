...
create table player (id bigint not null auto_increment, name varchar(255) not null, state varchar(255) not null, account_id bigint, primary key (id));
...
create table wayout (id bigint not null auto_increment, direction varchar(255) not null, room_id bigint not null, next_room_id bigint not null, door_id bigint not null, is_show boolean not null, primary key (id));
